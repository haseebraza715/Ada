...
procedure Main is
   ...
   function My_Action(NV: Integer) return Integer is
   begin
      if NV < 10 then
         return 0;
      else
   ...
   procedure Remove_Votes is new ForEach(My_Action);
...
begin
   ...
   Put_Line("5th place");
   Put_Line(Find_Nth_Place(A, 5)'Image);
